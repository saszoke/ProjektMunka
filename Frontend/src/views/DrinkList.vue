<template>
    <div v-if="isLoggedIn">
            <div class="d-flex justify-space-between">
                <h2 class="d-flex justify-md-center my-5 mx-5 mx-md-auto teal--text">Ital Lista</h2>
                <v-btn class="my-5 mx-5 mx-md-auto teal--text" rounded outlined @click="createAndSlide('drink')" v-if="isAdmin">
                    Új  ital
                </v-btn>
            </div>
            <v-data-iterator
                    ...
                    <template v-slot:footer>
                        <v-row class="mt-2 mx-5" align="center" justify="center">
                            ...
                            <v-menu offset-y>
                                ...
                                <v-list>
                                <v-list-item color="teal" v-for="(number, index) in itemsPerPageArray" :key="index" @click="updateItemsPerPage(number)">
                                    <v-list-item-title class="teal--text">{{ number }}</v-list-item-title>
                                </v-list-item>
                                </v-list>
                            </v-menu>
