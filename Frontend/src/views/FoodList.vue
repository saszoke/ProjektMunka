<template>
    <div v-if="isLoggedIn">
            <div class="d-flex justify-space-between">
                <h2 class="d-flex justify-md-center my-5 mx-5 mx-md-auto teal--text">Etel Lista</h2>
                <v-btn class="my-5 mx-5 mx-md-auto teal--text" rounded outlined @click="createAndSlide('food')" v-if="isAdmin">
                    Új  étel
                </v-btn>
            </div>
            <v-data-iterator
