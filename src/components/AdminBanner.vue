<template>
    <v-banner app color="teal accent-4" dark v-if="isLoggedIn & userSession.isAdmin">
        <div class="d-flex flex-wrap justify-center justify-md-space-between">
            ...
            <v-btn class="ma-2" color="blue-grey darken-1" @click="home" width="50%" max-width="200" dark> Kezdőoldal
            </v-btn>
...
export default {
    ...
    data: () => ({
        items: [
            ...
            {title: 'Személyzet', route: '/szemelyzet', imgSrc: 'https://cdn.vuetifyjs.com/images/parallax/material2.jpg', componentName: 'EmployeeList'},
            {title: 'Kijelentkezés', route: '/kijelentkezes', imgSrc: 'https://cdn.vuetifyjs.com/images/parallax/material2.jpg', componentName: 'Logout'},
        ],
