<template>
    <div v-if="isLoggedIn">
            <div class="d-flex justify-space-between">
                <h2 class="d-flex justify-md-center my-5 mx-5 mx-md-auto">Étel Lista</h2>
                <v-btn class="my-5 mx-5 mx-md-auto" rounded outlined @click="createAndSlide('food')" v-if="isAdmin">
                    Új  étel
                </v-btn>
            </div>
            <v-data-iterator
                ...
                <template v-slot:header>
                    ...
                    <template v-slot:footer>
                        <v-row class="mt-2 mx-5" align="center" justify="center">
                            <span class="grey--text mx-5">Elemek oldalanként</span>
                            <v-menu offset-y>
                            ...
                            <span class="mr-4 grey--text">
                                {{ page }}. oldal (összesen: {{ numberOfPages }}) 
                            </span>
    ...
    export default {
        ...
        methods: {
            ...
            createAndSlide(what){
                ...
                // { path: `/home/${identity}`, params: { identity: identity } }
            },
            deleteAndRefresh(id){
                this.deleteApi({
                    item: {id: id},
                ...
                this.items = []
                this.etelLista.forEach(etel => {
                    this.items.push(etel)
                });
            },
        },
        created(){
