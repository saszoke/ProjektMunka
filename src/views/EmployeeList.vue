<template>
    <div v-if="isLoggedIn">
            <div class="d-flex justify-space-between">
                <h2 class="d-flex justify-md-center my-5 mx-5 mx-md-auto">Személyek Lista</h2>
                <v-btn class="my-5 mx-5 mx-md-auto" rounded outlined @click="createAndSlide('employee')">
                    Új  személy
                </v-btn>
            </div>
            <v-data-iterator
