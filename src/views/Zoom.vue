<template>
  <div class="zoom" v-if="isLoggedIn && !isAdmin">
    ...
    <v-btn class="mt-15 mt-md-5" width="150" color="teal" rounded dark v-if="getTable(this.$route.params.id).orderState == 'ordered'"  @click="deliverOrder($route.params.id)">Kivittem</v-btn>
